---
title: "State POTS Replacement Requirements: Who Sets Them"
seoTitle: "State POTS Replacement Requirements"
date: "2026-09-18"
category: "Compliance & Regulation"
description: "State POTS replacement requirements come from three layers: FCC carrier rules, a narrow state role, and adopted life-safety codes. What each one governs."
author: "Carter Dewey"
readTime: "6 min read"
image: "/blog-images/state-pots-replacement-requirements-who-sets-them.png"
---
...
A state's power sits in the discontinuance process, and it is narrower than it first appears. [47 U.S.C. § 214](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title47-section214&num=0&edition=prelim) requires that notice of a carrier's application go to the Governor of each state in which service is proposed to be discontinued, reduced or impaired, and gives those notified the right to be heard — which lets a state object before the Commission authorizes anything. Section 214(c) then lets the United States, the Commission, the state commission, any state affected, or any party in interest sue to enjoin a discontinuance carried out contrary to that section.

Separately, [47 U.S.C. § 253(b)](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title47-section253&num=0&edition=prelim) preserves a state's ability to impose, on a competitively neutral basis, requirements necessary to preserve and advance universal service, protect the public safety and welfare, ensure the continued quality of telecommunications services, and safeguard the rights of consumers.
...
Name the carrier of record for every circuit still on copper, and put one owner on that list. Ask in writing for its retirement or discontinuance plan and the dates touching your sites, and keep the answer — carriers must send copies of their discontinuance applications to the state public utility commissions ([FCC 26-19](https://www.federalregister.gov/documents/2026/04/20/2026-07622/reducing-barriers-to-network-improvements-and-service-changes)), so the docket is a second place to confirm what you were told. Then check the code edition your state or local jurisdiction has adopted for fire alarm and elevator communications: that is where the in-building requirements carrying an inspection consequence live.

Two references shorten that work. [Elevator Phone Requirements: What the Codes Actually Say](/blog/elevator-phone-requirements-what-codes-actually-say) covers the code side, and the [FCC's copper retirement notice rules](/blog/fcc-copper-retirement-notice-what-carriers-file) cover the filing side of the same event.

Sort the obligations by who owns them before you budget anything. Device certifications belong to the equipment maker. The 911, Kari's Law and RAY BAUM'S obligations travel with the voice network that carries the calls, not with the deployment. The migration work — inventory, cutover, testing — belongs to a deployment partner. To see where your exposure sits first, the [copper sunset risk assessment](/tools/copper-sunset-risk) walks a portfolio site by site.

---

A state requirement is not a plan, and a carrier's notice is not a date on your calendar until someone owns it. [Tell us what your sites still run on copper](/contact) and we will map the replacements, the [POTS replacement path](/pots-replacement) each service needs, and the compliance layers that travel with it.
