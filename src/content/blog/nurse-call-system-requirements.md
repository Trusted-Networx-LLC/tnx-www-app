---
title: "Nurse Call System Requirements: What the Codes Require"
date: "2026-09-16"
category: "Compliance & Regulation"
description: "Nurse call system requirements: the life-safety and health care codes that apply, what the equipment standard covers, and the records a surveyor will ask for."
author: "Carter Dewey"
readTime: "6 min read"
image: "/blog-images/nurse-call-system-requirements.png"
---
...
Start with the occupancy, because the requirement follows the building, not the equipment brochure. A hospital must meet the applicable provisions of the Life Safety Code and, separately, must proceed in accordance with the Health Care Facilities Code — chapters 7, 8, 12 and 13 of NFPA 99 do not apply — under [42 CFR § 482.41](https://www.ecfr.gov/current/title-42/section-482.41). A long-term care facility is held to the same two codes, with the same four chapters carved out, under [42 CFR § 483.90](https://www.ecfr.gov/current/title-42/section-483.90). Both sections let CMS waive specific provisions on a hardship finding, which is why the waiver letter in your file can matter as much as the code text when a surveyor asks how a condition was met.
...
The product side has its own standard. ANSI/UL 1069, Hospital Signaling and Nurse Call Equipment, is the UL standard written for this category; UL's current edition is dated February 8, 2024 and is ANSI-approved ([UL 1069](https://www.shopulstandards.com/ProductDetail.aspx?productId=UL1069)). It addresses the equipment, not your facility's compliance program.
